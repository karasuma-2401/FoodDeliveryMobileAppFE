...
interface ChatRepository {
    ...
    suspend fun createConversation(sellerId: Int): Result<ConversationEntity>
    suspend fun markAsRead(conversationId: String): Result<Unit>

    fun getMessages(conversationId: String): Flow<List<MessageEntity>>
    suspend fun syncMessages(conversationId: String, page: Int): Result<ConversationEntity>
    suspend fun syncConversationDetail(conversationId: Int, page: Int): Result<ConversationEntity>
    suspend fun syncConversationDetailByOrder(orderId: Int, page: Int): Result<ConversationEntity>
